...
* 可以扫码下载 Demo 进行演示或者测试，如果扫码下载不了的，[点击此处可直接下载](https://github.com/getActivity/EasyWindow/releases/download/12.8/EasyWindow.apk)
...
dependencies {
    ...
    implementation 'com.github.getActivity:EasyWindow:12.8'
}
```
